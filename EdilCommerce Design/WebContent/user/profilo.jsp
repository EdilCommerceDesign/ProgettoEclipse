		...
		<fieldset>
			  <legend>Informazioni Personali:</legend>
					<table>
						...
						<tr><td>Conferma Password </td> <td><input id="confermaPass" type="password" name="confermaP" placeholder="Password" required readonly value="<%= bean.getUserPassword() %>" onblur="controllaPass('pass', 'confermaPass','messaggioPass')"></td><td><p hidden="true" id="messaggioPass" style="color:red;margin:0">X</td></tr>
